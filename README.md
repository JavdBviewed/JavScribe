...
🖥️ **JavScribe Client**（桌面客户端）v0.2.3：[Windows 安装包](https://github.com/JavdBviewed/JavScribe/releases/download/client-v0.2.3/jav-scribe-client-0.2.3-win-x64-setup.exe) · [Windows 便携版](https://github.com/JavdBviewed/JavScribe/releases/download/client-v0.2.3/jav-scribe-client-0.2.3-win-x64-portable.exe) · [Linux AppImage](https://github.com/JavdBviewed/JavScribe/releases/download/client-v0.2.3/jav-scribe-client-0.2.3-linux-x64.AppImage) · [Linux deb](https://github.com/JavdBviewed/JavScribe/releases/download/client-v0.2.3/jav-scribe-client_0.2.3_amd64.deb) · [全部资产](https://github.com/JavdBviewed/JavScribe/releases/tag/client-v0.2.3)
